        ...
        @foreach ($data as $row)
            <tr>
              ...
              <td>
                  ...
                  <a href="/dashboard-kemahasiswaan/data-pengajuan/{{ $row->id_dokumen }}/edit" type="button" class="btn btn-warning btn-sm"><i class="nav-icon fas fa-exclamation-circle"></i> Detail</a>
              </td>
            </tr>
        @endforeach
      </tbody>

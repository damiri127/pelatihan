...
<a href="/dashboard-ormawa/buat-pengajuan/create" class="btn btn-success mb-3 ml-3"><i class="nav-icon fas fa-plus"></i> Tambah data</a>
  <br>
  <div class="card">
    <!-- /.card-header -->
          ...
          @foreach ($data as $row)
            <tr>
              ...
              <td class="px-3">
                <div class="row">
                  <div class="col-auto">
                    <a href="/dashboard-ormawa/buat-pengajuan/{{ $row->id_dokumen}}/edit" class="btn btn-sm btn-warning"><i class="nav-icon fas fa-pen"></i></a>
                  </div>
                  <div class="col-auto">
                    <form action="/dashboard-ormawa/buat-pengajuan/{{ $row->id_dokumen}}" method="POST">
                      @csrf
                      @method('DELETE')
